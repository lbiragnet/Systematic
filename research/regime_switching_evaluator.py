...
from evaluator_base import DataLoader, Evaluator, BacktestEngine, WalkForwardEvaluator
...
class RegimeSwitchingEvaluator(Evaluator):
    ...
    def evaluate(
        self, data: pd.DataFrame, strategy: Strategy, param_grid: List[Dict], n_runs=5
    ):
    ...
    def _generate_path(
        ...
        for _ in range(length):
            ...
            # Draw return from the current regime
...
if __name__ == "__main__":
    ...
    if not data.empty:
        ...
        regime_evaluator = RegimeSwitchingEvaluator(engine, wf_evaluator)
